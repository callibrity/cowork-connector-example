...
If you find a bug, please [open an issue](https://github.com/callibrity/cowork-connector-example/issues/new) and include:
...
- `src/main/java/com/callibrity/cowork/connector/catalog/` — domain model, repositories, service layer, MCP tool adapter, seed data
- `src/main/java/com/callibrity/cowork/connector/feedback/` — self-improvement tools (`submit-feedback`, `suggest-tool`) for evolving the server based on LLM-reported friction
